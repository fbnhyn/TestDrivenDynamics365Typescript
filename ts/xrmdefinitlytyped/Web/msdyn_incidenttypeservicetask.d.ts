...
interface msdyn_incidenttypeservicetask_Relationships {
  ...
  msdyn_incidenttypeservicetask_AsyncOperations?: AsyncOperation_Result[] | null;
  msdyn_incidenttypeservicetask_BulkDeleteFailures?: BulkDeleteFailure_Result[] | null;
  msdyn_incidenttypeservicetask_DuplicateBaseRecord?: DuplicateRecord_Result[] | null;
  msdyn_incidenttypeservicetask_DuplicateMatchingRecord?: DuplicateRecord_Result[] | null;
  msdyn_incidenttypeservicetask_MailboxTrackingFolders?: MailboxTrackingFolder_Result[] | null;
  msdyn_incidenttypeservicetask_PrincipalObjectAttributeAccesses?: PrincipalObjectAttributeAccess_Result[] | null;
  msdyn_incidenttypeservicetask_ProcessSession?: ProcessSession_Result[] | null;
  msdyn_incidenttypeservicetask_SyncErrors?: SyncError_Result[] | null;
  msdyn_incidenttypeservicetask_UserEntityInstanceDatas?: UserEntityInstanceData_Result[] | null;
}
...
interface msdyn_incidenttypeservicetask_Expand {
  ...
  msdyn_Inspection: WebExpand<msdyn_incidenttypeservicetask_Expand, msdyn_inspection_Select, msdyn_inspection_Filter, { msdyn_Inspection: msdyn_inspection_Result }>;
  ...
  msdyn_incidenttypeservicetask_AsyncOperations: WebExpand<msdyn_incidenttypeservicetask_Expand, AsyncOperation_Select, AsyncOperation_Filter, { msdyn_incidenttypeservicetask_AsyncOperations: AsyncOperation_Result[] }>;
  msdyn_incidenttypeservicetask_BulkDeleteFailures: WebExpand<msdyn_incidenttypeservicetask_Expand, BulkDeleteFailure_Select, BulkDeleteFailure_Filter, { msdyn_incidenttypeservicetask_BulkDeleteFailures: BulkDeleteFailure_Result[] }>;
  msdyn_incidenttypeservicetask_DuplicateBaseRecord: WebExpand<msdyn_incidenttypeservicetask_Expand, DuplicateRecord_Select, DuplicateRecord_Filter, { msdyn_incidenttypeservicetask_DuplicateBaseRecord: DuplicateRecord_Result[] }>;
  msdyn_incidenttypeservicetask_DuplicateMatchingRecord: WebExpand<msdyn_incidenttypeservicetask_Expand, DuplicateRecord_Select, DuplicateRecord_Filter, { msdyn_incidenttypeservicetask_DuplicateMatchingRecord: DuplicateRecord_Result[] }>;
  msdyn_incidenttypeservicetask_MailboxTrackingFolders: WebExpand<msdyn_incidenttypeservicetask_Expand, MailboxTrackingFolder_Select, MailboxTrackingFolder_Filter, { msdyn_incidenttypeservicetask_MailboxTrackingFolders: MailboxTrackingFolder_Result[] }>;
  msdyn_incidenttypeservicetask_PrincipalObjectAttributeAccesses: WebExpand<msdyn_incidenttypeservicetask_Expand, PrincipalObjectAttributeAccess_Select, PrincipalObjectAttributeAccess_Filter, { msdyn_incidenttypeservicetask_PrincipalObjectAttributeAccesses: PrincipalObjectAttributeAccess_Result[] }>;
  msdyn_incidenttypeservicetask_ProcessSession: WebExpand<msdyn_incidenttypeservicetask_Expand, ProcessSession_Select, ProcessSession_Filter, { msdyn_incidenttypeservicetask_ProcessSession: ProcessSession_Result[] }>;
  msdyn_incidenttypeservicetask_SyncErrors: WebExpand<msdyn_incidenttypeservicetask_Expand, SyncError_Select, SyncError_Filter, { msdyn_incidenttypeservicetask_SyncErrors: SyncError_Result[] }>;
  msdyn_incidenttypeservicetask_UserEntityInstanceDatas: WebExpand<msdyn_incidenttypeservicetask_Expand, UserEntityInstanceData_Select, UserEntityInstanceData_Filter, { msdyn_incidenttypeservicetask_UserEntityInstanceDatas: UserEntityInstanceData_Result[] }>;
...
interface msdyn_incidenttypeservicetask_RelatedMany {
  msdyn_incidenttypeservicetask_AsyncOperations: WebMappingRetrieve<AsyncOperation_Select,AsyncOperation_Expand,AsyncOperation_Filter,AsyncOperation_Fixed,AsyncOperation_Result,AsyncOperation_FormattedResult>;
  msdyn_incidenttypeservicetask_BulkDeleteFailures: WebMappingRetrieve<BulkDeleteFailure_Select,BulkDeleteFailure_Expand,BulkDeleteFailure_Filter,BulkDeleteFailure_Fixed,BulkDeleteFailure_Result,BulkDeleteFailure_FormattedResult>;
  msdyn_incidenttypeservicetask_DuplicateBaseRecord: WebMappingRetrieve<DuplicateRecord_Select,DuplicateRecord_Expand,DuplicateRecord_Filter,DuplicateRecord_Fixed,DuplicateRecord_Result,DuplicateRecord_FormattedResult>;
  msdyn_incidenttypeservicetask_DuplicateMatchingRecord: WebMappingRetrieve<DuplicateRecord_Select,DuplicateRecord_Expand,DuplicateRecord_Filter,DuplicateRecord_Fixed,DuplicateRecord_Result,DuplicateRecord_FormattedResult>;
  msdyn_incidenttypeservicetask_MailboxTrackingFolders: WebMappingRetrieve<MailboxTrackingFolder_Select,MailboxTrackingFolder_Expand,MailboxTrackingFolder_Filter,MailboxTrackingFolder_Fixed,MailboxTrackingFolder_Result,MailboxTrackingFolder_FormattedResult>;
  msdyn_incidenttypeservicetask_PrincipalObjectAttributeAccesses: WebMappingRetrieve<PrincipalObjectAttributeAccess_Select,PrincipalObjectAttributeAccess_Expand,PrincipalObjectAttributeAccess_Filter,PrincipalObjectAttributeAccess_Fixed,PrincipalObjectAttributeAccess_Result,PrincipalObjectAttributeAccess_FormattedResult>;
  msdyn_incidenttypeservicetask_ProcessSession: WebMappingRetrieve<ProcessSession_Select,ProcessSession_Expand,ProcessSession_Filter,ProcessSession_Fixed,ProcessSession_Result,ProcessSession_FormattedResult>;
  msdyn_incidenttypeservicetask_SyncErrors: WebMappingRetrieve<SyncError_Select,SyncError_Expand,SyncError_Filter,SyncError_Fixed,SyncError_Result,SyncError_FormattedResult>;
  msdyn_incidenttypeservicetask_UserEntityInstanceDatas: WebMappingRetrieve<UserEntityInstanceData_Select,UserEntityInstanceData_Expand,UserEntityInstanceData_Filter,UserEntityInstanceData_Fixed,UserEntityInstanceData_Result,UserEntityInstanceData_FormattedResult>;
}
