...
interface TeamMembership_Relationships {
  ...
  userentityinstancedata_teammembership?: UserEntityInstanceData_Result[] | null;
}
...
interface TeamMembership_Expand {
  ...
  userentityinstancedata_teammembership: WebExpand<TeamMembership_Expand, UserEntityInstanceData_Select, UserEntityInstanceData_Filter, { userentityinstancedata_teammembership: UserEntityInstanceData_Result[] }>;
}
...
interface TeamMembership_RelatedMany {
  ...
  userentityinstancedata_teammembership: WebMappingRetrieve<UserEntityInstanceData_Select,UserEntityInstanceData_Expand,UserEntityInstanceData_Filter,UserEntityInstanceData_Fixed,UserEntityInstanceData_Result,UserEntityInstanceData_FormattedResult>;
}
