...
interface msdyn_PostAlbum_Relationships {
  ...
  msdyn_postalbum_msdyn_approvals?: msdyn_approval_Result[] | null;
  msdyn_postalbum_msdyn_bookingalerts?: msdyn_bookingalert_Result[] | null;
  msdyn_postalbum_msdyn_ocliveworkitems?: msdyn_ocliveworkitem_Result[] | null;
  msdyn_postalbum_msdyn_ocoutboundmessages?: msdyn_ocoutboundmessage_Result[] | null;
  msdyn_postalbum_msdyn_ocsessions?: msdyn_ocsession_Result[] | null;
  msdyn_postalbum_msfp_alerts?: msfp_alert_Result[] | null;
  msdyn_postalbum_msfp_surveyinvites?: msfp_surveyinvite_Result[] | null;
  msdyn_postalbum_msfp_surveyresponses?: msfp_surveyresponse_Result[] | null;
}
...
interface msdyn_PostAlbum_Expand {
  ...
  msdyn_postalbum_msdyn_approvals: WebExpand<msdyn_PostAlbum_Expand, msdyn_approval_Select, msdyn_approval_Filter, { msdyn_postalbum_msdyn_approvals: msdyn_approval_Result[] }>;
  msdyn_postalbum_msdyn_bookingalerts: WebExpand<msdyn_PostAlbum_Expand, msdyn_bookingalert_Select, msdyn_bookingalert_Filter, { msdyn_postalbum_msdyn_bookingalerts: msdyn_bookingalert_Result[] }>;
  msdyn_postalbum_msdyn_ocliveworkitems: WebExpand<msdyn_PostAlbum_Expand, msdyn_ocliveworkitem_Select, msdyn_ocliveworkitem_Filter, { msdyn_postalbum_msdyn_ocliveworkitems: msdyn_ocliveworkitem_Result[] }>;
  msdyn_postalbum_msdyn_ocoutboundmessages: WebExpand<msdyn_PostAlbum_Expand, msdyn_ocoutboundmessage_Select, msdyn_ocoutboundmessage_Filter, { msdyn_postalbum_msdyn_ocoutboundmessages: msdyn_ocoutboundmessage_Result[] }>;
  msdyn_postalbum_msdyn_ocsessions: WebExpand<msdyn_PostAlbum_Expand, msdyn_ocsession_Select, msdyn_ocsession_Filter, { msdyn_postalbum_msdyn_ocsessions: msdyn_ocsession_Result[] }>;
  msdyn_postalbum_msfp_alerts: WebExpand<msdyn_PostAlbum_Expand, msfp_alert_Select, msfp_alert_Filter, { msdyn_postalbum_msfp_alerts: msfp_alert_Result[] }>;
  msdyn_postalbum_msfp_surveyinvites: WebExpand<msdyn_PostAlbum_Expand, msfp_surveyinvite_Select, msfp_surveyinvite_Filter, { msdyn_postalbum_msfp_surveyinvites: msfp_surveyinvite_Result[] }>;
  msdyn_postalbum_msfp_surveyresponses: WebExpand<msdyn_PostAlbum_Expand, msfp_surveyresponse_Select, msfp_surveyresponse_Filter, { msdyn_postalbum_msfp_surveyresponses: msfp_surveyresponse_Result[] }>;
...
interface msdyn_PostAlbum_RelatedMany {
  ...
  msdyn_postalbum_msdyn_approvals: WebMappingRetrieve<msdyn_approval_Select,msdyn_approval_Expand,msdyn_approval_Filter,msdyn_approval_Fixed,msdyn_approval_Result,msdyn_approval_FormattedResult>;
  msdyn_postalbum_msdyn_bookingalerts: WebMappingRetrieve<msdyn_bookingalert_Select,msdyn_bookingalert_Expand,msdyn_bookingalert_Filter,msdyn_bookingalert_Fixed,msdyn_bookingalert_Result,msdyn_bookingalert_FormattedResult>;
  msdyn_postalbum_msdyn_ocliveworkitems: WebMappingRetrieve<msdyn_ocliveworkitem_Select,msdyn_ocliveworkitem_Expand,msdyn_ocliveworkitem_Filter,msdyn_ocliveworkitem_Fixed,msdyn_ocliveworkitem_Result,msdyn_ocliveworkitem_FormattedResult>;
  msdyn_postalbum_msdyn_ocoutboundmessages: WebMappingRetrieve<msdyn_ocoutboundmessage_Select,msdyn_ocoutboundmessage_Expand,msdyn_ocoutboundmessage_Filter,msdyn_ocoutboundmessage_Fixed,msdyn_ocoutboundmessage_Result,msdyn_ocoutboundmessage_FormattedResult>;
  msdyn_postalbum_msdyn_ocsessions: WebMappingRetrieve<msdyn_ocsession_Select,msdyn_ocsession_Expand,msdyn_ocsession_Filter,msdyn_ocsession_Fixed,msdyn_ocsession_Result,msdyn_ocsession_FormattedResult>;
  msdyn_postalbum_msfp_alerts: WebMappingRetrieve<msfp_alert_Select,msfp_alert_Expand,msfp_alert_Filter,msfp_alert_Fixed,msfp_alert_Result,msfp_alert_FormattedResult>;
  msdyn_postalbum_msfp_surveyinvites: WebMappingRetrieve<msfp_surveyinvite_Select,msfp_surveyinvite_Expand,msfp_surveyinvite_Filter,msfp_surveyinvite_Fixed,msfp_surveyinvite_Result,msfp_surveyinvite_FormattedResult>;
  msdyn_postalbum_msfp_surveyresponses: WebMappingRetrieve<msfp_surveyresponse_Select,msfp_surveyresponse_Expand,msfp_surveyresponse_Filter,msfp_surveyresponse_Fixed,msfp_surveyresponse_Result,msfp_surveyresponse_FormattedResult>;
}
