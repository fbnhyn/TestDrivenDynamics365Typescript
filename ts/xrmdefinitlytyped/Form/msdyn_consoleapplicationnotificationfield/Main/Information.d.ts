declare namespace Form.msdyn_consoleapplicationnotificationfield.Main {
  namespace Information {
    namespace Tabs {
    }
    interface Attributes extends Xrm.AttributeCollectionBase {
      get(name: "msdyn_lineheader"): Xrm.Attribute<string>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      get(name: "msdyn_lineheader"): Xrm.StringControl;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    getAttribute(attributeName: "msdyn_lineheader"): Xrm.Attribute<string>;
    ...
    getControl(controlName: "msdyn_lineheader"): Xrm.StringControl;
