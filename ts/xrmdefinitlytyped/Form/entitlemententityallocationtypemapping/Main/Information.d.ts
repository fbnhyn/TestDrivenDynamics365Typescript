declare namespace Form.entitlemententityallocationtypemapping.Main {
  namespace Information {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      get(name: "allocationtype"): Xrm.OptionSetAttribute<allocationtype>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      get(name: "allocationtype"): Xrm.OptionSetControl<allocationtype>;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    getAttribute(attributeName: "allocationtype"): Xrm.OptionSetAttribute<allocationtype>;
    ...
    getControl(controlName: "allocationtype"): Xrm.OptionSetControl<allocationtype>;
