declare namespace Form.msdyn_agreement.Main {
  namespace AgreementMobile {
    namespace Tabs {
      ...
      interface fstab_general extends Xrm.SectionCollectionBase {
        ...
        get(name: "fstab_general_section_details"): Xrm.PageSection;
  ...
  interface AgreementMobile extends Xrm.PageBase<AgreementMobile.Attributes,AgreementMobile.Tabs,AgreementMobile.Controls> {
