declare namespace Form.msdyn_purchaseorderreceiptproduct.Main {
  namespace PurchaseOrderReceiptProductMobile {
    namespace Tabs {
      interface fstab_general extends Xrm.SectionCollectionBase {
        ...
        get(name: "fstab_general_section_4"): Xrm.PageSection;
        get(name: "fstab_general_section_general"): Xrm.PageSection;
        get(name: "fstab_general_section_quantity_cost"): Xrm.PageSection;
      ...
      interface fstab_other extends Xrm.SectionCollectionBase {
        ...
        get(name: "fstab_quantity_cost_section_2"): Xrm.PageSection;
        get(name: "fstab_quantity_cost_section_3"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
      ...
      interface fstab_product_associates_to extends Xrm.SectionCollectionBase {
        ...
        get(name: "fstab_product_associates_to_section_2"): Xrm.PageSection;
        get(name: "fstab_product_associates_to_section_3"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
  ...
  interface PurchaseOrderReceiptProductMobile extends Xrm.PageBase<PurchaseOrderReceiptProductMobile.Attributes,PurchaseOrderReceiptProductMobile.Tabs,PurchaseOrderReceiptProductMobile.Controls> {
