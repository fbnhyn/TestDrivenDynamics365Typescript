declare namespace Form.dynamicproperty.Main {
  namespace Property {
    namespace Tabs {
      interface dynamic_property_properties extends Xrm.SectionCollectionBase {
        get(name: "dynamic_property_properties_2"): Xrm.PageSection;
        get(name: "dynamic_property_properties_3"): Xrm.PageSection;
        get(name: "dynamic_property_properties_41"): Xrm.PageSection;
      ...
      interface dynamic_property_summary extends Xrm.SectionCollectionBase {
        ...
        get(name: "dynamic_property_properties_31"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "grid_DynamicPropertyOptionSetItem"): Xrm.SubGridControl<"dynamicpropertyoptionsetitem">;
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      get(name: "dynamic_property_properties"): Xrm.PageTab<Tabs.dynamic_property_properties>;
  ...
  interface Property extends Xrm.PageBase<Property.Attributes,Property.Tabs,Property.Controls> {
    ...
    getControl(controlName: "grid_DynamicPropertyOptionSetItem"): Xrm.SubGridControl<"dynamicpropertyoptionsetitem">;
