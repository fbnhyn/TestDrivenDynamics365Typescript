declare namespace Form.msdyn_incidenttypeservice.QuickCreate {
  namespace IncidentTypeServiceQuickCreate {
    namespace Tabs {
  ...
  interface IncidentTypeServiceQuickCreate extends Xrm.PageBase<IncidentTypeServiceQuickCreate.Attributes,IncidentTypeServiceQuickCreate.Tabs,IncidentTypeServiceQuickCreate.Controls> {
