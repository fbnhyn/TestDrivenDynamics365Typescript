declare namespace Form.msdyn_geolocationtracking.Main {
  namespace Information {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "msdyn_userid"): Xrm.LookupAttribute<"systemuser">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdyn_userid"): Xrm.LookupControl<"systemuser">;
      get(name: string): undefined;
      get(): Xrm.BaseControl[];
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "msdyn_userid"): Xrm.LookupAttribute<"systemuser">;
    ...
    getControl(controlName: "msdyn_userid"): Xrm.LookupControl<"systemuser">;
