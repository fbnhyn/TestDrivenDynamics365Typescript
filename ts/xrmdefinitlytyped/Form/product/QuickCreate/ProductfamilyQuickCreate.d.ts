declare namespace Form.product.QuickCreate {
  namespace ProductfamilyQuickCreate {
    namespace Tabs {
  ...
  interface ProductfamilyQuickCreate extends Xrm.PageBase<ProductfamilyQuickCreate.Attributes,ProductfamilyQuickCreate.Tabs,ProductfamilyQuickCreate.Controls> {
