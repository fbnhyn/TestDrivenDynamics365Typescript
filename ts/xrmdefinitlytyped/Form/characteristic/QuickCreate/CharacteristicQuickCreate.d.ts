declare namespace Form.characteristic.QuickCreate {
  namespace CharacteristicQuickCreate {
    namespace Tabs {
  ...
  interface CharacteristicQuickCreate extends Xrm.PageBase<CharacteristicQuickCreate.Attributes,CharacteristicQuickCreate.Tabs,CharacteristicQuickCreate.Controls> {
