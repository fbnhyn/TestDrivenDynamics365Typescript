declare namespace Form.msdyn_operatinghour.QuickCreate {
  namespace Operatinghours {
    namespace Tabs {
      interface tab_1 extends Xrm.SectionCollectionBase {
        get(name: "tab_1_column_1_section_1"): Xrm.PageSection;
        get(name: "tab_1_column_1_section_2"): Xrm.PageSection;
  ...
  interface Operatinghours extends Xrm.PageBase<Operatinghours.Attributes,Operatinghours.Tabs,Operatinghours.Controls> {
