declare namespace Form.msdyn_propertyassetassociation.QuickCreate {
  namespace PropertyAssetAssociationQuickCreate {
    namespace Tabs {
  ...
  interface PropertyAssetAssociationQuickCreate extends Xrm.PageBase<PropertyAssetAssociationQuickCreate.Attributes,PropertyAssetAssociationQuickCreate.Tabs,PropertyAssetAssociationQuickCreate.Controls> {
