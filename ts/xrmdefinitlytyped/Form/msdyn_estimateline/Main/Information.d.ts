declare namespace Form.msdyn_estimateline.Main {
  namespace Information {
    namespace Tabs {
      interface d8123bfe186b4faf8ece48dd82a8dce9 extends Xrm.SectionCollectionBase {
        get(name: "ActivityGroup"): Xrm.PageSection;
        get(name: "AmountGroup"): Xrm.PageSection;
        get(name: "BillingGroup"): Xrm.PageSection;
        get(name: "DateGroup"): Xrm.PageSection;
        get(name: "PartyGroup"): Xrm.PageSection;
        get(name: "ProductResourceGroup"): Xrm.PageSection;
        get(name: "QuantityGroup"): Xrm.PageSection;
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      get(name: "{d8123bfe-186b-4faf-8ece-48dd82a8dce9}"): Xrm.PageTab<Tabs.d8123bfe186b4faf8ece48dd82a8dce9>;
      get(name: string): undefined;
