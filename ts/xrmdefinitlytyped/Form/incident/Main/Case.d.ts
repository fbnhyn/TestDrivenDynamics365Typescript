declare namespace Form.incident.Main {
  namespace Case {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      get(name: "actualserviceunits"): Xrm.NumberAttribute;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "actualserviceunits"): Xrm.NumberControl;
  ...
  interface Case extends Xrm.PageBase<Case.Attributes,Case.Tabs,Case.Controls> {
    getAttribute(attributeName: "actualserviceunits"): Xrm.NumberAttribute;
    ...
    getControl(controlName: "actualserviceunits"): Xrm.NumberControl;
