declare namespace Form.msdyn_configuration.Main {
  namespace Information1 {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "msdyn_type"): Xrm.OptionSetAttribute<msdyn_configuration_msdyn_type>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdyn_type"): Xrm.OptionSetControl<msdyn_configuration_msdyn_type>;
  ...
  interface Information1 extends Xrm.PageBase<Information1.Attributes,Information1.Tabs,Information1.Controls> {
    ...
    getAttribute(attributeName: "msdyn_type"): Xrm.OptionSetAttribute<msdyn_configuration_msdyn_type>;
    getAttribute(attributeName: "msdyn_value"): Xrm.Attribute<string>;
    getAttribute(attributeName: "ownerid"): Xrm.LookupAttribute<"systemuser" | "team">;
    getAttribute(attributeName: string): undefined;
    getAttribute(delegateFunction: Xrm.Collection.MatchingDelegate<Xrm.Attribute<any>>): Xrm.Attribute<any>[];
    getControl(controlName: "msdyn_name"): Xrm.StringControl;
    getControl(controlName: "msdyn_type"): Xrm.OptionSetControl<msdyn_configuration_msdyn_type>;
