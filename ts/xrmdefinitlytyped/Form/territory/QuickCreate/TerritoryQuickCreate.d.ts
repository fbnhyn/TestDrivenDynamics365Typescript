declare namespace Form.territory.QuickCreate {
  namespace TerritoryQuickCreate {
    namespace Tabs {
  ...
  interface TerritoryQuickCreate extends Xrm.PageBase<TerritoryQuickCreate.Attributes,TerritoryQuickCreate.Tabs,TerritoryQuickCreate.Controls> {
