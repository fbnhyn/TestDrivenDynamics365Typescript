declare namespace Form.msdyn_agreementbookingincident.Main {
  ...
  interface AgreementBookingIncidentMobile extends Xrm.PageBase<AgreementBookingIncidentMobile.Attributes,AgreementBookingIncidentMobile.Tabs,AgreementBookingIncidentMobile.Controls> {
