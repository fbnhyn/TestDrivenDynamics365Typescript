declare namespace Form.msdyn_taxcode.QuickCreate {
  namespace TaxCodeQuickCreateFS5x5 {
    namespace Tabs {
  ...
  interface TaxCodeQuickCreateFS5x5 extends Xrm.PageBase<TaxCodeQuickCreateFS5x5.Attributes,TaxCodeQuickCreateFS5x5.Tabs,TaxCodeQuickCreateFS5x5.Controls> {
