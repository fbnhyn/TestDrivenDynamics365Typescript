declare namespace Form.savedquery.Main {
  namespace Information {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "iscustomizable"): Xrm.OptionSetAttribute<boolean>;
      get(name: "isdefault"): Xrm.OptionSetAttribute<boolean>;
      get(name: "isquickfindquery"): Xrm.OptionSetAttribute<boolean>;
      get(name: "isuserdefined"): Xrm.OptionSetAttribute<boolean>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "iscustomizable"): Xrm.OptionSetControl<boolean>;
      get(name: "isdefault"): Xrm.OptionSetControl<boolean>;
      get(name: "isquickfindquery"): Xrm.OptionSetControl<boolean>;
      get(name: "isuserdefined"): Xrm.OptionSetControl<boolean>;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "iscustomizable"): Xrm.OptionSetAttribute<boolean>;
    getAttribute(attributeName: "isdefault"): Xrm.OptionSetAttribute<boolean>;
    getAttribute(attributeName: "isquickfindquery"): Xrm.OptionSetAttribute<boolean>;
    getAttribute(attributeName: "isuserdefined"): Xrm.OptionSetAttribute<boolean>;
    ...
    getControl(controlName: "iscustomizable"): Xrm.OptionSetControl<boolean>;
    getControl(controlName: "isdefault"): Xrm.OptionSetControl<boolean>;
    getControl(controlName: "isquickfindquery"): Xrm.OptionSetControl<boolean>;
    getControl(controlName: "isuserdefined"): Xrm.OptionSetControl<boolean>;
