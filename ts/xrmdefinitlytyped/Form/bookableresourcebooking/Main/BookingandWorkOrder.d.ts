declare namespace Form.bookableresourcebooking.Main {
  namespace BookingandWorkOrder {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "msdyn_signature"): Xrm.Attribute<string>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdyn_signature"): Xrm.StringControl;
      ...
      get(name: "msdyn_workorder1"): Xrm.LookupControl<"msdyn_workorder">;
      get(name: "msdyn_workorder2"): Xrm.LookupControl<"msdyn_workorder">;
      get(name: "msdyn_workorder3"): Xrm.LookupControl<"msdyn_workorder">;
  ...
  interface BookingandWorkOrder extends Xrm.PageBase<BookingandWorkOrder.Attributes,BookingandWorkOrder.Tabs,BookingandWorkOrder.Controls> {
    ...
    getAttribute(attributeName: "msdyn_signature"): Xrm.Attribute<string>;
    ...
    getControl(controlName: "msdyn_signature"): Xrm.StringControl;
    ...
    getControl(controlName: "msdyn_workorder1"): Xrm.LookupControl<"msdyn_workorder">;
    getControl(controlName: "msdyn_workorder2"): Xrm.LookupControl<"msdyn_workorder">;
    getControl(controlName: "msdyn_workorder3"): Xrm.LookupControl<"msdyn_workorder">;
