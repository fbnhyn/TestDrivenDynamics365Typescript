declare namespace Form.bookableresourcebooking.Main {
  namespace ResourceBookingMobileDeprecated {
    namespace Tabs {
  ...
  interface ResourceBookingMobileDeprecated extends Xrm.PageBase<ResourceBookingMobileDeprecated.Attributes,ResourceBookingMobileDeprecated.Tabs,ResourceBookingMobileDeprecated.Controls> {
