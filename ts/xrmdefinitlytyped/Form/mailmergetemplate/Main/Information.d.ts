declare namespace Form.mailmergetemplate.Main {
  namespace Information {
    namespace Tabs {
      interface general extends Xrm.SectionCollectionBase {
        get(name: "Categorization"): Xrm.PageSection;
        get(name: "Details"): Xrm.PageSection;
        get(name: "Language"): Xrm.PageSection;
        get(name: "Ownership"): Xrm.PageSection;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "ispersonal"): Xrm.OptionSetControl<boolean>;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getControl(controlName: "ispersonal"): Xrm.OptionSetControl<boolean>;
