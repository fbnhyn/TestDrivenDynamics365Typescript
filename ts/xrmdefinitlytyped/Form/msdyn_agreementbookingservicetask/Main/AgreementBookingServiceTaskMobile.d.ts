declare namespace Form.msdyn_agreementbookingservicetask.Main {
  namespace AgreementBookingServiceTaskMobile {
    namespace Tabs {
      interface fstab_general extends Xrm.SectionCollectionBase {
        ...
        get(name: "fstab_general_section_service_task_relates_to"): Xrm.PageSection;
  ...
  interface AgreementBookingServiceTaskMobile extends Xrm.PageBase<AgreementBookingServiceTaskMobile.Attributes,AgreementBookingServiceTaskMobile.Tabs,AgreementBookingServiceTaskMobile.Controls> {
