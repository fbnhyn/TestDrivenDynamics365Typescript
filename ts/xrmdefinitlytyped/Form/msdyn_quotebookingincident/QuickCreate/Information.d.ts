declare namespace Form.msdyn_quotebookingincident.QuickCreate {
  namespace Information {
    namespace Tabs {
      interface QuoteBookingIncidentTab extends Xrm.SectionCollectionBase {
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      get(name: "QuoteBookingIncidentTab"): Xrm.PageTab<Tabs.QuoteBookingIncidentTab>;
      get(name: string): undefined;
