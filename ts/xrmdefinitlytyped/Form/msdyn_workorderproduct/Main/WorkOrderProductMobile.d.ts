declare namespace Form.msdyn_workorderproduct.Main {
  namespace WorkOrderProductMobile {
    namespace Tabs {
      interface fstab_estimate extends Xrm.SectionCollectionBase {
        get(name: "fstab_estimate_cost_amount"): Xrm.PageSection;
        get(name: "fstab_estimate_section_sale_amount"): Xrm.PageSection;
      ...
      interface fstab_general extends Xrm.SectionCollectionBase {
        get(name: "fstab_general_section_6"): Xrm.PageSection;
        get(name: "fstab_general_section_INVENTORY"): Xrm.PageSection;
      ...
      interface fstab_pricing extends Xrm.SectionCollectionBase {
        get(name: "fstab_pricing_section_cost_amount"): Xrm.PageSection;
        get(name: "fstab_pricing_section_sale_amount"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
  ...
  interface WorkOrderProductMobile extends Xrm.PageBase<WorkOrderProductMobile.Attributes,WorkOrderProductMobile.Tabs,WorkOrderProductMobile.Controls> {
