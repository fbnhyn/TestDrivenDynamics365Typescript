declare namespace Form.list.Main {
  namespace MarketingListLight {
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "accountsUCI"): Xrm.SubGridControl<"account">;
      get(name: "contacts"): Xrm.SubGridControl<"contact">;
      get(name: "contactsUCI"): Xrm.SubGridControl<"contact">;
      ...
      get(name: "leadsUCI"): Xrm.SubGridControl<"lead">;
  ...
  interface MarketingListLight extends Xrm.PageBase<MarketingListLight.Attributes,MarketingListLight.Tabs,MarketingListLight.Controls> {
    ...
    getControl(controlName: "accountsUCI"): Xrm.SubGridControl<"account">;
    getControl(controlName: "contacts"): Xrm.SubGridControl<"contact">;
    getControl(controlName: "contactsUCI"): Xrm.SubGridControl<"contact">;
    ...
    getControl(controlName: "leadsUCI"): Xrm.SubGridControl<"lead">;
