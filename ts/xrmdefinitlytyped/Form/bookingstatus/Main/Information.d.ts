declare namespace Form.bookingstatus.Main {
  namespace Information {
    namespace Tabs {
      ...
      interface ProjectService extends Xrm.SectionCollectionBase {
        get(name: "ProjectService_section_1"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "msdyn_committype"): Xrm.OptionSetAttribute<msdyn_committype>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdyn_committype"): Xrm.OptionSetControl<msdyn_committype>;
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      ...
      get(name: "ProjectService"): Xrm.PageTab<Tabs.ProjectService>;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "msdyn_committype"): Xrm.OptionSetAttribute<msdyn_committype>;
    ...
    getControl(controlName: "msdyn_committype"): Xrm.OptionSetControl<msdyn_committype>;
