declare namespace Form.msdyn_workorderincident.Quick {
  namespace WOResolutionQuickView {
    namespace Tabs {
  ...
  interface WOResolutionQuickView extends Xrm.PageBase<WOResolutionQuickView.Attributes,WOResolutionQuickView.Tabs,WOResolutionQuickView.Controls> {
