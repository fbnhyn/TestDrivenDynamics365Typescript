declare namespace Form.msdyn_workorderincident.Main {
  namespace Information {
    namespace Tabs {
      interface f1tab_resolution extends Xrm.SectionCollectionBase {
        ...
        get(name: "workorderresolutionksection"): Xrm.PageSection;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "workorderresolutiongrid"): Xrm.SubGridControl<"msdyn_workorderresolution">;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getControl(controlName: "workorderresolutiongrid"): Xrm.SubGridControl<"msdyn_workorderresolution">;
