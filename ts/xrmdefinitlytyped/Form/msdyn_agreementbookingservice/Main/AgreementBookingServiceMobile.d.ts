declare namespace Form.msdyn_agreementbookingservice.Main {
  namespace AgreementBookingServiceMobile {
    namespace Tabs {
      ...
      interface fstab_sub_grids extends Xrm.SectionCollectionBase {
        get(name: "fstab_sub_grids"): Xrm.PageSection;
  ...
  interface AgreementBookingServiceMobile extends Xrm.PageBase<AgreementBookingServiceMobile.Attributes,AgreementBookingServiceMobile.Tabs,AgreementBookingServiceMobile.Controls> {
