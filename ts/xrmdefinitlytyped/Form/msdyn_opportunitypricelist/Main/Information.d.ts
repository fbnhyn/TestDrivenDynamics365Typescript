declare namespace Form.msdyn_opportunitypricelist.Main {
  namespace Information {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "msdyn_opportunity"): Xrm.LookupAttribute<"opportunity">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdyn_opportunity"): Xrm.LookupControl<"opportunity">;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "msdyn_opportunity"): Xrm.LookupAttribute<"opportunity">;
    ...
    getControl(controlName: "msdyn_opportunity"): Xrm.LookupControl<"opportunity">;
