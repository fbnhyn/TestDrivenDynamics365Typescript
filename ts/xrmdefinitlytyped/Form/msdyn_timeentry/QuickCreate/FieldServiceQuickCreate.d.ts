declare namespace Form.msdyn_timeentry.QuickCreate {
  namespace FieldServiceQuickCreate {
    namespace Tabs {
      interface TimeEntryQuickCreateForm extends Xrm.SectionCollectionBase {
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      get(name: "Time Entry Quick Create Form"): Xrm.PageTab<Tabs.TimeEntryQuickCreateForm>;
      get(name: string): undefined;
  ...
  interface FieldServiceQuickCreate extends Xrm.PageBase<FieldServiceQuickCreate.Attributes,FieldServiceQuickCreate.Tabs,FieldServiceQuickCreate.Controls> {
