declare namespace Form.msdyn_quotelinetransactionclassification.Main {
  namespace Information {
    namespace Tabs {
      ...
      interface _88b25a3a8a9b4242a326af609ba47cc0 extends Xrm.SectionCollectionBase {
        get(name: "{88b25a3a-8a9b-4242-a326-af609ba47cc0}_section_2"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      get(name: "ResourceCategoriesGrid"): Xrm.SubGridControl<"msdyn_quotelineresourcecategory">;
      get(name: "TransactionCategoriesGrid"): Xrm.SubGridControl<"msdyn_quotelinetransactioncategory">;
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      ...
      get(name: "{88b25a3a-8a9b-4242-a326-af609ba47cc0}"): Xrm.PageTab<Tabs._88b25a3a8a9b4242a326af609ba47cc0>;
      get(name: string): undefined;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getControl(controlName: "ResourceCategoriesGrid"): Xrm.SubGridControl<"msdyn_quotelineresourcecategory">;
    getControl(controlName: "TransactionCategoriesGrid"): Xrm.SubGridControl<"msdyn_quotelinetransactioncategory">;
