declare namespace Form.role.Main {
  namespace Information {
    namespace Tabs {
      interface general extends Xrm.SectionCollectionBase {
        get(name: "role information"): Xrm.PageSection;
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "parentroleid"): Xrm.LookupAttribute<"role">;
      get(name: string): undefined;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "parentroleid"): Xrm.LookupControl<"role">;
      get(name: string): undefined;
      get(): Xrm.BaseControl[];
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "parentroleid"): Xrm.LookupAttribute<"role">;
    ...
    getControl(controlName: "parentroleid"): Xrm.LookupControl<"role">;
