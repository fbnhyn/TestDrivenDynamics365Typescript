declare namespace Form.customeropportunityrole.Main {
  namespace Information {
    namespace Tabs {
      interface general extends Xrm.SectionCollectionBase {
        get(name: "Opportunity Relationship Information"): Xrm.PageSection;
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "opportunityroleid"): Xrm.LookupAttribute<"relationshiprole">;
      get(name: string): undefined;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "opportunityroleid"): Xrm.LookupControl<"relationshiprole">;
      get(name: string): undefined;
      get(): Xrm.BaseControl[];
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "opportunityroleid"): Xrm.LookupAttribute<"relationshiprole">;
    ...
    getControl(controlName: "opportunityroleid"): Xrm.LookupControl<"relationshiprole">;
