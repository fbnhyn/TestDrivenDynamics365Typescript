declare namespace Form.bookableresourcecharacteristic.Main {
  namespace OmnichannelBookableResourceCharacteristicMainForm {
    namespace Tabs {
    }
  ...
  interface OmnichannelBookableResourceCharacteristicMainForm extends Xrm.PageBase<OmnichannelBookableResourceCharacteristicMainForm.Attributes,OmnichannelBookableResourceCharacteristicMainForm.Tabs,OmnichannelBookableResourceCharacteristicMainForm.Controls> {
