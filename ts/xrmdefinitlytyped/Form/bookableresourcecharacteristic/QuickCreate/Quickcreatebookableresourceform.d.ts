declare namespace Form.bookableresourcecharacteristic.QuickCreate {
  namespace Quickcreatebookableresourceform {
    namespace Tabs {
  ...
  interface Quickcreatebookableresourceform extends Xrm.PageBase<Quickcreatebookableresourceform.Attributes,Quickcreatebookableresourceform.Tabs,Quickcreatebookableresourceform.Controls> {
