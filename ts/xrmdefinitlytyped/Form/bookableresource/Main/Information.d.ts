declare namespace Form.bookableresource.Main {
  namespace Information {
    namespace Tabs {
      ...
      interface tab_projectservice extends Xrm.SectionCollectionBase {
        get(name: "tab_2_section_1"): Xrm.PageSection;
        get(name: "tab_2_section_2"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "calendarid"): Xrm.LookupAttribute<"calendar">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "ResourceRole"): Xrm.SubGridControl<"bookableresourcecategoryassn">;
      get(name: "Resourceskills"): Xrm.SubGridControl<"bookableresourcecharacteristic">;
      get(name: "accountid"): Xrm.LookupControl<"account">;
      get(name: "calendarid"): Xrm.LookupControl<"calendar">;
      ...
      get(name: "userid1"): Xrm.LookupControl<"systemuser">;
      get(name: string): undefined;
      get(): Xrm.BaseControl[];
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      ...
      get(name: "tab_projectservice"): Xrm.PageTab<Tabs.tab_projectservice>;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "calendarid"): Xrm.LookupAttribute<"calendar">;
    ...
    getControl(controlName: "ResourceRole"): Xrm.SubGridControl<"bookableresourcecategoryassn">;
    getControl(controlName: "Resourceskills"): Xrm.SubGridControl<"bookableresourcecharacteristic">;
    getControl(controlName: "accountid"): Xrm.LookupControl<"account">;
    getControl(controlName: "calendarid"): Xrm.LookupControl<"calendar">;
    ...
    getControl(controlName: "userid1"): Xrm.LookupControl<"systemuser">;
