declare namespace Form.quote.Quick {
  namespace QuoteViewForm {
    namespace Tabs {
  ...
  interface QuoteViewForm extends Xrm.PageBase<QuoteViewForm.Attributes,QuoteViewForm.Tabs,QuoteViewForm.Controls> {
