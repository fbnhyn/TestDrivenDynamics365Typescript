declare namespace Form.salesorder.Quick {
  namespace OrderQuickViewForm {
    namespace Tabs {
  ...
  interface OrderQuickViewForm extends Xrm.PageBase<OrderQuickViewForm.Attributes,OrderQuickViewForm.Tabs,OrderQuickViewForm.Controls> {
