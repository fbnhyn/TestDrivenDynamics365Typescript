declare namespace Form.msdyn_expense.QuickCreate {
  ...
  interface CreateExpense extends Xrm.PageBase<CreateExpense.Attributes,CreateExpense.Tabs,CreateExpense.Controls> {
