declare namespace Form.msdyn_quotelineinvoiceschedule.Main {
  namespace ProjectInformation {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "statecode"): Xrm.OptionSetAttribute<msdyn_quotelineinvoiceschedule_statecode>;
      get(name: string): undefined;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "statecode"): Xrm.OptionSetControl<msdyn_quotelineinvoiceschedule_statecode>;
      get(name: string): undefined;
      get(): Xrm.BaseControl[];
  ...
  interface ProjectInformation extends Xrm.PageBase<ProjectInformation.Attributes,ProjectInformation.Tabs,ProjectInformation.Controls> {
    ...
    getAttribute(attributeName: "statecode"): Xrm.OptionSetAttribute<msdyn_quotelineinvoiceschedule_statecode>;
    ...
    getControl(controlName: "statecode"): Xrm.OptionSetControl<msdyn_quotelineinvoiceschedule_statecode>;
