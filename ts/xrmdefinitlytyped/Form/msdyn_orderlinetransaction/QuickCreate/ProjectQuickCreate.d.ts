declare namespace Form.msdyn_orderlinetransaction.QuickCreate {
  namespace ProjectQuickCreate {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "msdyn_salescontract"): Xrm.LookupAttribute<"salesorder">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdyn_salescontract"): Xrm.LookupControl<"salesorder">;
  ...
  interface ProjectQuickCreate extends Xrm.PageBase<ProjectQuickCreate.Attributes,ProjectQuickCreate.Tabs,ProjectQuickCreate.Controls> {
    ...
    getAttribute(attributeName: "msdyn_salescontract"): Xrm.LookupAttribute<"salesorder">;
    ...
    getControl(controlName: "msdyn_salescontract"): Xrm.LookupControl<"salesorder">;
