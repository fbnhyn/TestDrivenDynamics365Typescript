declare namespace Form.msdyn_opportunitylinetransaction.Main {
  namespace Information {
    namespace Tabs {
      interface aa1fbbfa293f4830a2d4d1cb676eb355 extends Xrm.SectionCollectionBase {
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      get(name: "{aa1fbbfa-293f-4830-a2d4-d1cb676eb355}"): Xrm.PageTab<Tabs.aa1fbbfa293f4830a2d4d1cb676eb355>;
      get(name: string): undefined;
