declare namespace Form.knowledgearticleincident.Main {
  ...
  interface KnowledgeArticleIncident extends Xrm.PageBase<KnowledgeArticleIncident.Attributes,KnowledgeArticleIncident.Tabs,KnowledgeArticleIncident.Controls> {
