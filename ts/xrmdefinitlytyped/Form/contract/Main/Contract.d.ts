declare namespace Form.contract.Main {
  namespace Contract {
    namespace Tabs {
      interface general extends Xrm.SectionCollectionBase {
        ...
        get(name: "contract_line"): Xrm.PageSection;
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "statuscode"): Xrm.OptionSetAttribute<contract_statuscode>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      get(name: "Contract_lines"): Xrm.SubGridControl<"contractdetail">;
      ...
      get(name: "header_status"): Xrm.OptionSetControl<contract_statuscode>;
  ...
  interface Contract extends Xrm.PageBase<Contract.Attributes,Contract.Tabs,Contract.Controls> {
    ...
    getAttribute(attributeName: "statuscode"): Xrm.OptionSetAttribute<contract_statuscode>;
    ...
    getControl(controlName: "Contract_lines"): Xrm.SubGridControl<"contractdetail">;
    ...
    getControl(controlName: "header_status"): Xrm.OptionSetControl<contract_statuscode>;
