declare namespace Form.salesorderdetail.QuickCreate {
  namespace SalesOrderDetail {
    namespace Tabs {
      interface general extends Xrm.SectionCollectionBase {
        get(name: "delivery"): Xrm.PageSection;
  ...
  interface SalesOrderDetail extends Xrm.PageBase<SalesOrderDetail.Attributes,SalesOrderDetail.Tabs,SalesOrderDetail.Controls> {
