declare namespace Form.msdyn_purchaseorderreceipt.Main {
  namespace PurchaseOrderReceipt {
    namespace Tabs {
      interface fstab_receipt_products extends Xrm.SectionCollectionBase {
        get(name: "fstab_products_section_related"): Xrm.PageSection;
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "statecode"): Xrm.OptionSetAttribute<msdyn_purchaseorderreceipt_statecode>;
      get(name: string): undefined;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "footer_statecode"): Xrm.OptionSetControl<msdyn_purchaseorderreceipt_statecode>;
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      get(name: "fstab_receipt_products"): Xrm.PageTab<Tabs.fstab_receipt_products>;
      get(name: string): undefined;
  ...
  interface PurchaseOrderReceipt extends Xrm.PageBase<PurchaseOrderReceipt.Attributes,PurchaseOrderReceipt.Tabs,PurchaseOrderReceipt.Controls> {
    ...
    getAttribute(attributeName: "statecode"): Xrm.OptionSetAttribute<msdyn_purchaseorderreceipt_statecode>;
    getAttribute(attributeName: string): undefined;
    getAttribute(delegateFunction: Xrm.Collection.MatchingDelegate<Xrm.Attribute<any>>): Xrm.Attribute<any>[];
    getControl(controlName: "RECEIPT_PRODUCTS"): Xrm.SubGridControl<"msdyn_purchaseorderreceiptproduct">;
    getControl(controlName: "footer_statecode"): Xrm.OptionSetControl<msdyn_purchaseorderreceipt_statecode>;
