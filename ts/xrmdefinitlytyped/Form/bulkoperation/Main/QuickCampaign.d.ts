declare namespace Form.bulkoperation.Main {
  namespace QuickCampaign {
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "excluded_accounts"): Xrm.SubGridControl<"bulkoperationlog">;
      get(name: "excluded_contacts"): Xrm.SubGridControl<"bulkoperationlog">;
      get(name: "excluded_leads"): Xrm.SubGridControl<"bulkoperationlog">;
  ...
  interface QuickCampaign extends Xrm.PageBase<QuickCampaign.Attributes,QuickCampaign.Tabs,QuickCampaign.Controls> {
    ...
    getControl(controlName: "excluded_accounts"): Xrm.SubGridControl<"bulkoperationlog">;
    getControl(controlName: "excluded_contacts"): Xrm.SubGridControl<"bulkoperationlog">;
    getControl(controlName: "excluded_leads"): Xrm.SubGridControl<"bulkoperationlog">;
