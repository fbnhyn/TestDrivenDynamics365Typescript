declare namespace Form.opportunity.Main {
  namespace FieldServiceInformation {
    namespace Tabs {
      interface QUOTES extends Xrm.SectionCollectionBase {
        get(name: "QUOTES_section_2"): Xrm.PageSection;
      ...
      interface opportunity_line_items extends Xrm.SectionCollectionBase {
        get(name: "ServiceMaintenanceLines"): Xrm.PageSection;
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "salesstagecode"): Xrm.OptionSetAttribute<opportunity_salesstagecode>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "OpportunityServicesGrid"): Xrm.SubGridControl<"opportunityproduct">;
      ...
      get(name: "salesstagecode"): Xrm.OptionSetControl<opportunity_salesstagecode>;
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      ...
      get(name: "opportunity_line_items"): Xrm.PageTab<Tabs.opportunity_line_items>;
  ...
  interface FieldServiceInformation extends Xrm.PageBase<FieldServiceInformation.Attributes,FieldServiceInformation.Tabs,FieldServiceInformation.Controls> {
    ...
    getAttribute(attributeName: "salesstagecode"): Xrm.OptionSetAttribute<opportunity_salesstagecode>;
    ...
    getControl(controlName: "OpportunityServicesGrid"): Xrm.SubGridControl<"opportunityproduct">;
    ...
    getControl(controlName: "salesstagecode"): Xrm.OptionSetControl<opportunity_salesstagecode>;
