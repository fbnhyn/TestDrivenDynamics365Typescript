declare namespace Form.opportunity.InteractionCentricDashboard {
  namespace OpportunitiesDashboard {
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      get(name: "Component3ad71a5"): Xrm.SubGridControl<"opportunity">;
      get(name: "Component93e3d5a"): Xrm.SubGridControl<"opportunity">;
      get(name: "Componentd19026a"): Xrm.SubGridControl<"opportunity">;
      get(name: "Componentd60f252"): Xrm.SubGridControl<"opportunity">;
  ...
  interface OpportunitiesDashboard extends Xrm.PageBase<OpportunitiesDashboard.Attributes,OpportunitiesDashboard.Tabs,OpportunitiesDashboard.Controls> {
    ...
    getControl(controlName: "Component3ad71a5"): Xrm.SubGridControl<"opportunity">;
    getControl(controlName: "Component93e3d5a"): Xrm.SubGridControl<"opportunity">;
    getControl(controlName: "Componentd19026a"): Xrm.SubGridControl<"opportunity">;
    getControl(controlName: "Componentd60f252"): Xrm.SubGridControl<"opportunity">;
