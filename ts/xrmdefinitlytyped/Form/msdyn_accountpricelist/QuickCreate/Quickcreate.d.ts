declare namespace Form.msdyn_accountpricelist.QuickCreate {
  namespace Quickcreate {
    namespace Tabs {
      interface Pricelist extends Xrm.SectionCollectionBase {
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      get(name: "Price list"): Xrm.PageTab<Tabs.Pricelist>;
      get(name: string): undefined;
